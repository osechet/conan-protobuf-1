...
if __name__ == "__main__":
    ...
    if ci_manager.is_travis():
        if manager.get_branch() == "stable/3.9.1" and \
           ...
           os.getenv("TRAVIS_TOKEN"):
            json_data = {"request": {"branch": "release/3.9.1"}}
        ...
        if manager.get_branch() == "stable/3.9.1" and \
           ...
           os.getenv("APPVEYOR_TOKEN"):
            json_data = {"accountName":"BinCrafters", "projectSlug": "protobuf-integration-test", "branch": "release/3.9.1"}
